...
//       if (userType === "vendor") {
//         // Query Firestore for vendor with matching email and password
...
//         // Query Firestore for parent with matching student ID and password
//         const parentsRef = collection(db, "parents");
//         const q = query(parentsRef, where("studentId", "==", studentId), where("password", "==", password));
//         const querySnapshot = await getDocs(q);
